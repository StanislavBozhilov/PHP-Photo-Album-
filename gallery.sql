...
INSERT INTO `categories` VALUES (1,'Technology'),(2,'Games'),(3,'Auto/Vehicles'),(4,'Abstract');
...
CREATE TABLE `albums` (
  ...
  CONSTRAINT `fk_albums_categories` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `albums` VALUES (1,'THEY',NULL),(2,'Android',1),(3,'Clash of Clans',2);
